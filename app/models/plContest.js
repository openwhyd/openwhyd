...
exports.fetchOne = function (uri, cb) {
  mongodb.collections['plContest'].findOne({ uri: uri }, function (
    err,
    result
  ) {
    cb(result || { error: err });
...
exports.fetchLast = function (cb) {
  mongodb.collections['plContest'].find(
    {},
...
exports.fetchByTitle = function (title, cb) {
  mongodb.collections['plContest'].findOne({ title: title }, function (
    err,
    result
  ) {
    cb(result || { error: err });
...
exports.fetchById = function (id, cb) {
  mongodb.collections['plContest'].findOne(
