...
var activityController = require('./recentActivity.js');
var uiSnippets = require('../templates/uiSnippets.js');
var activityModel = require('../models/activity.js');
// const { renderPlaylists, MAX_SUBSCRIPTIONS, populateUsers, fetchActivity, MAX_PLAYLISTS_SIDE, MAX_FRIENDS, renderFriends } = require("./LibUser");

var MAX_PLAYLISTS_SIDE = 4;
exports.MAX_PLAYLISTS_SIDE = MAX_PLAYLISTS_SIDE;
var MAX_FRIENDS = 6;
exports.MAX_FRIENDS = MAX_FRIENDS;
var MAX_HISTORY = 3;
...
exports.renderPlaylists = renderPlaylists;
