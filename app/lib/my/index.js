...
exports.div = function() {
  return new Element('div', arguments);
};
exports.span = function() {
  return new Element('span', arguments);
};
exports.a = function() {
  return new Element('a', arguments);
};
exports.img = function() {
  return new Element('img', arguments);
};
exports.ul = function() {
  return new Element('ul', arguments);
};
exports.li = function() {
  return new Element('li', arguments);
};
exports.iframe = function() {
  return new Element('iframe', arguments);
};

// AJ

exports.p = function() {
  return new Element('p', arguments);
};
exports.br = function() {
  return new Element('br', arguments);
};
exports.h1 = function() {
  return new Element('h1', arguments);
};
