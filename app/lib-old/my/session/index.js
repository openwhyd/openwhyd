...
module.exports = function(options) {
  ...
  var HTTP_ONLY = options.httpOnly === false ? false : true;
  ...
  function writeSessionCookie(session, req, res) {
    ...
    if (typeof setCookieHeaderValue === 'string')
      setCookieHeaderValue = [setCookieHeaderValue, cookieString];
    else if (Array.isArray(setCookieHeaderValue))
      setCookieHeaderValue.push(cookieString);
    else setCookieHeaderValue = cookieString;
