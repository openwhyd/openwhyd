...
- `SENDGRID_API_KEY` (optional. API key of the Sendgrid account to be used for sending emails)
- `SENDGRID_API_FROM_EMAIL` (optional. email address of email sender)
- `SENDGRID_API_FROM_NAME` (optional. name of email sender)
- `MAILERSEND_API_KEY` (mandatory. API key of the MailerSend account to be used for sending emails)
- `MAILERSEND_API_FROM_EMAIL` (mandatory. email address of email sender)
- `MAILERSEND_API_FROM_NAME` (mandatory. name of email sender)
