...
window.Whyd.tracking = window.Whyd.tracking || (function(options){
	...
	var getWeekNumber = (function(){
		var MUL = 1000 * 60 * 60 * 24 * 7, FIRST_WEEK_DATE = new Date("Monday January 3, 2011 08:00");
	...
	function injectGoogleAnalytics(){
		...
		ga('create', 'UA-23759101-1', /*'auto',*/ {'alwaysSendReferrer': true});
	}
	...
	*/
	...
	if (!runsLocally)
		...
		window.ga = function(){}; //console.log.bind(console, "[GA]"); // fake google analytics
