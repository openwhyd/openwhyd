...
function trackCss () {
  ...
  var observer = new MutationObserver(function (mutations) {
	  mutations.forEach(function (mutation) {
	  	if (mutation.attributeName == 'style') { console.log(mutation.target, mutation.oldValue, '=>', mutation.target.style.cssText) }
...
function coucou () {
  ...
  if (window.user && window.user.lastFm) { $('.posts').bind('DOMNodeInserted', onEachPost).children().each(onEachPost) }
