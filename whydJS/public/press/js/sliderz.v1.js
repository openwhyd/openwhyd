(function($) {
  ...
  $.fn.sliderz = function() {
    ...
    currentSlide = 0;
    thisSlider.css({
      width: slide.eq(currentSlide).width(),
      height: slide.eq(currentSlide).height()
    });
    ...
    function nextSlide(e) {
      ...
      parentSlider.find('.sliderz-content').animate(
        {
          width: parentSlider
            .find('.sliderz-content li')
            .eq(currentSlide)
            .width(),
          height: parentSlider
            .find('.sliderz-content li')
