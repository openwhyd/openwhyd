(function () {
  ...
  var log = console.log = function () {
    ...
    for (var i in arguments) {
      if (arguments[i] instanceof Object || arguments[i] instanceof Array) { arguments[i] = JSON.stringify(arguments[i]) }
    }
  ...
  var TESTS = {
    ...
    'restore initial mnSub notif preference': function (cb) {
      jsonPost('/api/user', {'pref[mnSub]': testVars.initialMnSub}, function () {
        jsonGet('/api/user', {}, function (me) {
    ...
    'restore apTok': function (cb) {
      jsonPost('/api/user', {apTok: ''}, function () {
        jsonPost('/api/user', {apTok: (testVars.initialApTok.pop() || {tok: ''}).tok}, function () {
          jsonGet('/api/user', {}, function (me) {
