...
exports.whydTeam = [ // for access to admin endpoints
  {
...
exports.adminEmails = {}
for (var i in exports.whydTeam) { exports.adminEmails[exports.whydTeam[i].email] = true }
...
exports.addPrefix = function (url, urlPrefix) {
  return !url ? url : url.replace(/^\//, (urlPrefix || exports.urlPrefix) + '/')
}
...
exports.imgUrl = function (mid, freebaseThumbParams, urlPrefix) {
  ...
  if (!mid) return mid
  if (mid.startsWith('/yt/')) return 'https://i.ytimg.com/vi/' + mid.substr(4) + '/0.jpg'
  if (mid.startsWith('/dm/')) return 'https://www.dailymotion.com/thumbnail/video/' + mid.substr(4)
  if (mid.startsWith('/sc/')) return '/images/cover-soundcloud.jpg'
  if (mid == '/u/0') return urlPrefix + '/images/blank_user.gif'
  if (mid.startsWith('/u/')) return exports.userImg(mid/* .substr(3) */, urlPrefix) // return "http://graph.facebook.com/v2.3/"+mid.substr(3)+"/picture";//?type=large";
