...
var renderPage404 = mainTemplate.makeWhydPageRendererFromFile('public/html/404.html')
...
exports.renderErrorMessage = function (errorMessage, loggedUser) {
  var params = {
    ...
    content: "<div class='container'>" + snip.htmlEntities(errorMessage || 'Unexpected error, please go back and try again later.') + '</div>'
  }
...
exports.renderErrorResponse = function (errorObj, response, format, loggedUser) {
  var statusCode = errorObj && typeof errorObj.errorCode === 'number' && errorObj.errorCode
  ...
  } else if (errorObj.errorCode == 404 || errorObj.errorCode == 'USER_NOT_FOUND')
  // response.renderFile("public/html/404.html");
  {
    response.renderHTML(renderPage404({
      pageTitle: 'Oops...',
      loggedUser: loggedUser
    }), statusCode)
  } else if (errorObj.errorCode) { response.renderHTML(exports.renderErrorCode(errorObj.errorCode, loggedUser), statusCode) } else { response.renderHTML(exports.renderErrorMessage(errorObj.error, loggedUser), statusCode) }
}
