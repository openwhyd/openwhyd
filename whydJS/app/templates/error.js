...
exports.renderErrorResponse = function (errorObj, response, format, loggedUser){
	...
	if ((format || "").toLowerCase() == "json") {
		...
		response.renderHTML(exports.renderErrorCode(errorObj.errorCode, loggedUser), statusCode);
	else
		response.renderHTML(exports.renderErrorMessage(errorObj.error, loggedUser), statusCode);
}
