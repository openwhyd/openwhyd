...
exports.controller = function (request, getParams, response) {
  ...
  if (!getParams.uId || !getParams.plId) { return render('what the hell are you trying to do?') } // unlikely to happen ^^

  var loggedUser = null
  if (!(loggedUser = request.checkLogin(response))) { return }

  if (loggedUser.id != getParams.uId) { return render('what the hell are you doing here, mate?') }
