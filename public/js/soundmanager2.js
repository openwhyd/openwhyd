  ...
  function SoundManager(smURL, smID) {
    ...
    this.hasHTML5 = (function() {
      try {
        return (
          ...
          typeof new Audio().canPlayType !== 'undefined'
        );
      } catch (e) {
        return false;
      }
    ...
    var SMSound,
      ...
      _isBadSafari =
        ...
        _isSafari &&
        !_ua.match(/silk/i) &&
        _ua.match(/OS X 10_6_([3-7])/i), // Safari 4 and 5 (excluding Kindle Fire, "Silk") occasionally fail to load/play HTML5 audio on Snow Leopard 10.6.3 through 10.6.7 due to bug(s) in QuickTime X and/or other underlying frameworks. :/ Confirmed bug. https://bugs.webkit.org/show_bug.cgi?id=32159
      _hasConsole =
        typeof console !== 'undefined' && typeof console.log !== 'undefined',
      _isFocused =
        typeof _doc.hasFocus !== 'undefined' ? _doc.hasFocus() : null,
      _tryInitOnFocus =
        _isSafari && (typeof _doc.hasFocus === 'undefined' || !_doc.hasFocus()),
      _okToDisable = !_tryInitOnFocus,
      _flashMIME = /(mp3|mp4|mpa|m4a)/i,
      ...
      _netStreamPattern = new RegExp(
        '\\.(' + _netStreamTypes.join('|') + ')(\\?.*)?$',
        'i'
      );
    ...
    this.setup = function(options) {
      ...
      if (
        ...
        _needsFlash &&
        _s.ok() &&
        (typeof options.flashVersion !== 'undefined' ||
    ...
    this.canPlayMIME = function(sMIME) {
      ...
      if (!result && _needsFlash) {
        ...
        result =
          sMIME && _s.ok()
            ? !!(
                (_fV > 8 ? sMIME.match(_netStreamMimeTypes) : null) ||
                sMIME.match(_s.mimePattern)
              )
            : null;
      }
    ...
    this.getMoviePercent = function() {
      ...
      return _flash && typeof _flash.PercentLoaded !== 'undefined'
        ? _flash.PercentLoaded()
        : null;
    };
    ...
    SMSound = function(oOptions) {
      ...
      this.play = function(oOptions, _updatePlayState) {
        ...
        // default to true
        _updatePlayState =
          typeof _updatePlayState === 'undefined' ? true : _updatePlayState;
        ...
        if (_t.paused && _t.position && _t.position > 0) {
          ...
          if (
            !_t.instanceCount ||
            _t._iO.multiShotEvents ||
            (!_t.isHTML5 && _fV > 8 && !_t.getAutoPlay())
          ) {
            _t.instanceCount++;
          }
          ...
          _t.position =
            typeof _t._iO.position !== 'undefined' && !isNaN(_t._iO.position)
              ? _t._iO.position
              : 0;
          ...
          if (!_t.isHTML5) {
            ...
            if (_fV === 9 && !startOK) {
              ...
              _s._wD(
                fN + _t.id + ': No sound hardware, or 32-sound ceiling hit'
              );
      ...
      this.setAutoPlay = function(autoPlay) {
        _s._wD(
          'sound ' + _t.id + ' turned autoplay ' + (autoPlay ? 'on' : 'off')
        );
      ...
      this.setPosition = function(nMsecOffset) {
        ...
        if (!_t.isHTML5) {
          ...
          if (_t._html5_canplay) {
            ...
            _s._wD(
              'setPosition(' + position1K + '): delaying, sound not ready'
            );
          }
        }
      ...
      this.togglePause = function() {
        ...
        if (_t.playState === 0) {
          _t.play({
            position:
              _fV === 9 && !_t.isHTML5 ? _t.position : _t.position / 1000
          });
          return _t;
        }
      ...
      this.setVolume = function(nVol, _bInstanceOnly) {
        ...
        if (!_t.isHTML5) {
          _flash._setVolume(
            _t.id,
            (_s.muted && !_t.muted) || _t.muted ? 0 : nVol
          );
        } else if (_t._a) {
          // valid range: 0-1
      ...
      this._onTimer = function(bForce) {
        ...
        if (_t._hasTimer || bForce) {
          ...
          if (
            _t._a &&
            (bForce ||
              ((_t.playState > 0 || _t.readyState === 1) && !_t.paused))
          ) {
      ...
      this._get_html5_duration = function() {
        var _iO = _t._iO,
          ...
          result =
            d && !isNaN(d) && d !== Infinity ? d : _iO ? _iO.duration : null;
        ...
        if (_a) {
          if (_a._t) {
            if (!_useGlobalHTML5Audio && _dURL === d(_lastURL)) {
              ...
              _useGlobalHTML5Audio &&
              _oldIO.url === _iO.url &&
              (!_lastURL || _lastURL === _oldIO.url)
            ) {
              // iOS-type reuse case
              result = _a;
            }
          ...
          _s._wD(
            'setting URL on existing object: ' +
              _dURL +
              (_lastURL ? ', old URL: ' + _lastURL : '')
          );
      ...
      _add_html5_events = function() {
        ...
        function add(oEvt, oFn, bCapture) {
          return _t._a
            ? _t._a.addEventListener(oEvt, oFn, bCapture || false)
            : null;
        }
      ...
      _remove_html5_events = function() {
        ...
        function remove(oEvt, oFn, bCapture) {
          return _t._a
            ? _t._a.removeEventListener(oEvt, oFn, bCapture || false)
            : null;
        }
      ...
      this._onload = function(nSuccess) {
        ...
        _s._wD(
          fN +
            ...
            _t.id +
            '"' +
            (loadOK ? ' loaded.' : ' failed to load? - ' + _t.url),
          loadOK ? 1 : 2
        );
      ...
      this._whileloading = function(
        ...
        if (!_iO.isMovieStar) {
          if (_iO.duration) {
            ...
            _t.durationEstimate =
              _t.duration > _iO.duration ? _t.duration : _iO.duration;
          } else {
            _t.durationEstimate = parseInt(
              (_t.bytesTotal / _t.bytesLoaded) * _t.duration,
              10
            );
          }
      ...
      this._whileplaying = function(
        ...
        if (!_t.isHTML5 && _fV > 8) {
          ...
          if (
            _iO.useWaveformData &&
            typeof oWaveformDataLeft !== 'undefined' &&
            oWaveformDataLeft
          ) {
            _t.waveformData = {
      ...
      this._oncaptiondata = function(oData) {
        ...
        _s._wD(
          'SMSound._oncaptiondata(): "' + this.id + '" caption data received.'
        );
      ...
      this._onconnect = function(bSuccess) {
        ...
        _s._wD(
          'SMSound._onconnect(): "' +
            _t.id +
            '"' +
            (bSuccess ? ' connected.' : ' failed to connect? - ' + _t.url),
          bSuccess ? 1 : 2
        );
    ...
    _getDocument = function() {
      return (
        _doc.body || _doc._docElement || _doc.getElementsByTagName('div')[0]
      );
    };
        ...
        if (o.hasOwnProperty(i)) {
          ...
          if (
            ...
            if (hasParent && typeof extraOptions[oParent] !== 'undefined') {
              ...
              _complain(
                _str(
                  typeof _s[i] === 'undefined' ? 'setupUndef' : 'setupError',
                  i
                ),
                2
              );
    ...
    function _preferFlashCheck(kind) {
      ...
      return (
        ...
        _hasFlash &&
        !_s.ignoreFlash &&
        (typeof _s.flash[kind] !== 'undefined' && _s.flash[kind])
      );
    }
    ...
    _html5_events = {
      ...
      canplay: _html5_event(function() {
        ...
        position1K =
          typeof t._iO.position !== 'undefined' && !isNaN(t._iO.position)
            ? t._iO.position / 1000
            : null;
    ...
    */
      ...
      progress: _html5_event(function(e) {
        ...
        if (ranges && ranges.length) {
          ...
          if (isProgress && ranges.length > 1) {
            ...
            for (i = 0; i < j; i++) {
              str.push(
                e.target.buffered.start(i) + '-' + e.target.buffered.end(i)
              );
            }
    ...
    _strings = {
      ...
      waitFocus:
        _sm + ': Special case: Waiting for SWF to load with window focus...',
      waitImpatient: _sm + ': Getting impatient, still waiting for Flash%s...',
      waitForever:
        _sm + ': Waiting indefinitely for Flash (will recover if unblocked)...',
      ...
      waitEI:
        _smc + 'initMovie(): Waiting for ExternalInterface call from Flash...',
      ...
      fbTimeout:
        'No flash response, applying .' + _swfCSS.swfTimedout + ' CSS...',
      fbLoaded: 'Flash loaded',
      fbHandler: _smc + 'flashBlockHandler()',
      manURL: 'SMSound.load(): Using manually-assigned URL',
      onURL: _sm + '.load(): current URL already assigned.',
      badFV:
        _sm + '.flashVersion must be 8 or 9. "%s" is invalid. Reverting to %s.',
      as2loop:
      ...
      setupLate:
        _sm +
        '.setup(): url + flashVersion changes will not take effect until reboot().',
    ...
    _normalizeMovieURL = function(smURL) {
      ...
      if (smURL) {
        if (smURL.match(/\.swf(\?.*)?$/i)) {
          urlParams = smURL.substr(
            smURL.toLowerCase().lastIndexOf('.swf?') + 4
          );
          if (urlParams) {
      ...
      url =
        (smURL && smURL.lastIndexOf('/') !== -1
          ? smURL.substr(0, smURL.lastIndexOf('/') + 1)
          : './') + _s.movieURL;
    ...
    _setVersionInfo = function() {
      ...
      if (_fV > 8) {
        ...
        _s.filePatterns.flash9 = new RegExp(
          '\\.(mp3|' + _netStreamTypes.join('|') + ')(\\?.*)?$',
          'i'
        );
    ...
    _initDebug = function() {
      ...
      if (
        _s.debugMode &&
        !_id(_s.debugID) &&
        (!_hasConsole || !_s.useConsole || !_s.consoleOnly)
      ) {
    ...
    _processOnEvents = function(oOptions) {
      ...
      if (
        ...
        (_s.ok() || (_disabled && !oOptions.ignoreInit))
      ) {
        // invalid case
        return false;
      }
      ...
      var status = {
        ...
        srcQueue =
          oOptions && oOptions.type ? _on_queue[oOptions.type] || [] : [],
        queue = [],
        i,
        j,
        args = [status],
          ...
          if (formats.hasOwnProperty(item)) {
            if (
              (formats[item].required &&
                !_s.html5.canPlayType(formats[item].type)) ||
              (_s.preferFlash &&
                (_s.flash[item] || _s.flash[formats[item].type]))
            ) {
      ...
      if (!oSound._hasTimer) {
        ...
        if (!_mobileHTML5 && _s.html5PollingInterval) {
          if (_h5IntervalTimer === null && _h5TimerCount === 0) {
            _h5IntervalTimer = _win.setInterval(
              _timerExecute,
              _s.html5PollingInterval
            );
          }
    ...
    _timerExecute = function() {
      ...
      for (i = _s.soundIDs.length - 1; i >= 0; i--) {
        if (
          _s.sounds[_s.soundIDs[i]].isHTML5 &&
          _s.sounds[_s.soundIDs[i]]._hasTimer
        ) {
    ...
    this._setSandboxType = function(sandboxType) {
      ...
      sb.description =
        sb.types[
          typeof sb.types[sandboxType] !== 'undefined' ? sandboxType : 'unknown'
        ];
    ...
    this._externalInterfaceOK = function(flashDate, swfVersion) {
      ...
      if (
        ...
        swfVersion.replace(/\+dev/i, '') !==
          _s.versionNumber.replace(/\+dev/i, '')
      ) {
        e =
          _sm +
    ...
    _createMovie = function(smID, smURL) {
          ...
          '-- SoundManager 2 ' +
            ...
            (!_s.html5Only
              ? (_s.useHighPerformance ? ', high performance mode, ' : ', ') +
                ((_s.flashPollingInterval
                  ? 'custom (' + _s.flashPollingInterval + 'ms)'
                  : 'normal') +
                  ' polling') +
      ...
      if (oTarget) {
        ...
        if (!_s.oMC.id) {
          ...
          _s.oMC.className =
            (sClass ? sClass + ' ' : _swfCSS.swfDefault) +
      ...
      _s._wD(
        _smc +
          'createMovie(): Trying to load ' +
          smURL +
          (!_overHTTP && _s.altURL ? ' (alternate URL)' : ''),
        1
      );
    ...
    _showSupport = function() {
      ...
      if (_s.useHTML5Audio && _s.hasHTML5) {
        ...
        _s._wD(
          '-- SoundManager 2: HTML5 support tests (' +
            _s.html5Test +
            '): ' +
            tests.join(', ') +
            ' --',
    ...
    _initComplete = function(bNoDisable) {
      ...
      var wasTimeout =
          _s.useFlashBlock && _s.flashLoadTimeout && !_s.getMoviePercent(),
        result = true,
        error;
      ...
      if (!wasTimeout) {
        ...
        if (_disabled) {
          error = {
            type: !_hasFlash && _needsFlash ? 'NO_FLASH' : 'INIT_TIMEOUT'
          };
        }
      }
    ...
    _init = function() {
      ...
      try {
        ...
        _setPolling(
          true,
          _s.flashPollingInterval || (_s.useHighPerformance ? 10 : 50)
        );
